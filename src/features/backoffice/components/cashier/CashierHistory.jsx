      ...
      <article className="rounded-2xl border border-slate-100 bg-white p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02),0_12px_24px_rgba(0,0,0,0.02)] transition-all duration-300">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3.5">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-100/50 shadow-inner">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-xs font-extrabold uppercase tracking-widest text-slate-600 hover:bg-slate-50 hover:text-slate-800 active:scale-95 transition-all duration-200 cursor-pointer shadow-sm"
          >
          ...
          <div className="mt-6 space-y-4 animate-in fade-in duration-300">
            <div className="flex items-center justify-between rounded-2xl border border-slate-100 bg-slate-50/50 p-2 shadow-inner">
              <button
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-650 disabled:opacity-40 hover:bg-slate-50 active:scale-95 transition-all cursor-pointer shadow-sm"
              >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-3.5 py-2 text-xs font-extrabold uppercase tracking-widest text-white hover:bg-slate-800 active:scale-95 transition-all cursor-pointer disabled:opacity-50"
                        >
